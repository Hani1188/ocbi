...
function onNodeSelecting(args) {
    ...
    if (args.nodeData.parentID == "1000000") {
        if (user == 'Admin' || user == "RegionalManager") {
            //Region
            console.log("Region " + id + " clicked, do nothing for now...not implemented.")
        }
        else {
            console.log("Sorry you don't have access to this level.")
        }
    } else if (args.nodeData.parentID != null && args.nodeData.hasChildren == false) {
        //Store
    ...
    } else if (args.nodeData.parentID == "99") {
        if (user == 'Admin') {
            //Territory
    ...
    } else if (args.nodeData.parentID == null) {
        if (user == 'Admin') {
            //All Stores
            console.log(id + " clicked, TODO get All Stores data...not implemented.")
        }
        else {
            console.log("Sorry you don't have access to this level.")
        }
